...
#PJM --stgout "rank=* %r:./result/* /data/hp120263/fukuda/inhib_plast/result/%j/"
#PJM --stgout "rank=* %r:./change/* /data/hp120263/fukuda/inhib_plast/change/%j/"
